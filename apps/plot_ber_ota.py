...
if __name__ == "__main__":
    ...
    EbN0_range2 =[13, 15, 17, 19, 21, 23, 25]
    ber_simu_1M = [0.30032, 0.11328, 0.089125, 0.013697, 0.0044838, 0.0013263, 0.00022017]
    ...
    s.semilogy(EbN0_range4, ber_simu4, 'g-o', label="OTA BPSK Rx gain=43dB")
    s.semilogy(EbN0_range, ber_simu_30M, 'r-o', label="OTA BPSK Rx gain=33dB")
    s.semilogy(EbN0_range2, ber_simu_1M, 'b-o', label="OTA BPSK Rx gain=23dB")
